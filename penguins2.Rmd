...
maleplot <- ggplot(penguins1_MALE, aes(x = culmen_length_mm, y = flipper_length_mm)) +
  ...
  labs(caption = str_wrap('The figure presents plots of Adelaide (female up; male down) penguins and their flipper and culment length relationship through a linear regression plot with 95% confidence level. The relationship for males was stiatistically shown to be significant, visualised by a slope upwards'))
