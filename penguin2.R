...
# setwd('/Users/viggorey/Desktop/PenguinProject') <- my path

setwd('your path to folder with this file')
...
### Data analysis  -----------------------
## Examining if culmen length explains flipper length in female and male Adelie penguins according to collected data using linear regression obtaining a p-value 
...
# Second create two datasets, one for female data and one for male data, separating out Adelie penguin data for each as well
...
# Also make sure data has equal variance and is normally distributed
plot(penguinF_mod,2) # For female data
plot(penguinF_mod,1)

plot(penguinM_mod,2) # For male data
plot(penguinM_mod,1)

# Variance in Y is constant over all X values
# No systematic change in distribution of residuals along 0
